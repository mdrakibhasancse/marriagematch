                        ...
                        <div class="thumb-info-wrapper thumb-info-wrapper-opacity-6">
                            ...
                            <div class="thumb-info-title bg-transparent p-4">
                                <div class="thumb-info-inner mt-1">
                                    <h2 class="font-weight-bold text-color-light line-height-2 text-5 mb-0">{{ $post->localeTitleShow() }}</h2>
                                </div>
                                <div class="thumb-info-show-more-content">
                                    <p class="mb-0 text-1 line-height-9 mb-1 mt-2 text-light opacity-5">{{ $post->localeExcerptShow() }}</p>
                                </div>
                            </div>
                        </div>
                    </article>
                        ...
                        <div class="col-sm-7 ps-sm-1">
                            <div class="thumb-info-caption-text">
                                ...
                                <h2 class="d-block line-height-2 text-4 text-dark font-weight-bold mt-1 mb-0">
                                    <a href="{{ route('singlePost', ['slug' => $post->slug ?? \Str::slug($post->localeTitleShow()) ])}}" class="text-decoration-none text-color-dark text-color-hover-primary">{{ $post->localeTitleShow() }}</a>
                                </h2>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col">
                                        <div class="thumb-info-caption-text">
                                            ...
                                            <h4 class="d-block line-height-2 text-4 text-dark font-weight-bold mb-0">
                                                <a href="{{ route('singlePost', ['slug' => $category->latestFirstPost()->slug ?? \Str::slug($category->latestFirstPost()->localeTitleShow()) ])}}" class="text-decoration-none text-color-dark text-color-hover-primary">   {{$category->latestFirstPost()->localeTitleShow()}}</a>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="thumb-info-caption-text">
                                                ...
                                                <h4 class="d-block pb-2 line-height-2 text-3 text-dark font-weight-bold mb-0">
                                                    <a href="{{ route('singlePost', ['slug' => $post->slug ?? \Str::slug($post->localeTitleShow()) ])}}" class="text-decoration-none text-color-dark text-color-hover-primary">
                                                        {{ Str::limit($post->localeTitleShow(), 20) }}
                                                    </a>
                                                </h4>
                                            </div>
                                        </div>
                        ...
                        <li>
                            <article>
                                ...
                                <div class="post-info">
                                    ...
                                    <h4 class="font-weight-normal text-3 mb-0"><a href="{{ route('singlePost', ['slug' => $post->slug ?? \Str::slug($post->localeTitleShow())])}}" class="text-dark">{{ $post->localeTitleShow() }}</a></h4>
                                </div>
                            </article>
                        </li>
                        @endforeach
