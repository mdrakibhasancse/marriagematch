                        ...
                        <div class="col-sm-7 ps-sm-1">
                            <div class="thumb-info-caption-text">
                                ...
                                <h2 class="d-block line-height-2 text-4 text-dark font-weight-bold mt-1 mb-0">
                                    <a href="{{ route('singlePost', ['id' => $post->id , 'slug' => $post->slug])}}" class="text-decoration-none text-color-dark text-color-hover-primary">{{ $post->title }}</a>
                                </h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row pb-1">
                    <div class="col-lg-6 mb-4 pb-1">
                        <article class="thumb-info thumb-info-no-zoom bg-transparent border-radius-0 pb-2 mb-2">
                            <div class="row">
                                <div class="col">
                                    <a href="{{ route('singlePost', ['id' => $category->latestFirstPost()->id , 'slug' => $category->latestFirstPost()->slug])}}">
                                        <img src="{{ route('imagecache', [ 'template'=>'original','filename' => $category->latestFirstPost()->fi() ]) }}" class="img-fluid border-radius-0" alt=">{{ $category->latestFirstPost()->title }}">
                                    </a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="thumb-info-caption-text">
                                        ...
                                        <h4 class="d-block line-height-2 text-4 text-dark font-weight-bold mb-0">
                                            <a href="{{ route('singlePost', ['id' => $category->latestFirstPost()->id , 'slug' => $category->latestFirstPost()->slug])}}" class="text-decoration-none text-color-dark text-color-hover-primary">{{ $category->latestFirstPost()->title }}</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <article class="thumb-info thumb-info-no-zoom bg-transparent border-radius-0 pb-4 mb-2">
                            <div class="row align-items-center pb-1">
                                <div class="col-sm-4">
                                    <a href="{{ route('singlePost', ['id' => $post->id , 'slug' => $post->slug])}}">
                                        <img src="{{ route('imagecache', [ 'template'=>'pplg','filename' => $post->fi() ]) }}" class="img-fluid border-radius-0" alt="Gadgets That Make Your Smartphone Even Smarter">
                                    </a>
                                </div>
                            ...
                            <li>
                                <article>
                                    ...
                                    <div class="post-info">
                                        ...
                                        <h4 class="font-weight-normal text-3 mb-0"><a href="{{ route('singlePost', ['id' => $post->id , 'slug' => $post->slug])}}" class="text-dark">{{ $post->title }}</a></h4>
                                    </div>
                                </article>
                            </li>
                            @endforeach
