...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{{ $user->name}}</strong>, <br>Your order is successfully paid.</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">Your order  number is : {{ $order->id}}.</span></p>
<p style="line-height: 1.5; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>

<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">Your package name :  {{ $order->package->title }}.</span></p>
<p style="line-height: 1.5; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>

<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">Total paid amount : {{ $order->paid_amount }}.</span></p>
<p style="line-height: 1.5; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
...
<p style="line-height: 1.5; word-break: break-word; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">Thank you so much for joining with us! <br/></span> --}}
	{{-- <span style="font-size: 16px;">Your Temporary Password is: {{ $user->password_temp }}</span> --}}
	<br>
</p>
</div>
</div>
