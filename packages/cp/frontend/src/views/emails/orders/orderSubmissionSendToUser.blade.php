...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{{$user->name}}</strong>,<br>Your order is successfully submitted</span></p>
</div>
</div>
...
<p style="font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Login your account now &amp;<br/><span style="color: #132f40; font-size: 16px;"><strong>Go to your dashboard for details</strong></span></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
