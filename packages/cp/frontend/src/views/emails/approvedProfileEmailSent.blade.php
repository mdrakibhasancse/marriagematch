...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{{ $user->name }}</strong>,<br>আপনি প্রোফাইল এর সকল ডাটা সফল ভাবে সাবমিট করেছেন । দয়া করে এপ্রুভের জন্য অপেক্ষা করুন.</span></p>
</div>
</div>
...
<p style="line-height: 1.5; word-break: break-word; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">Thank you so much for joining with us! <br/></p>
<br>
