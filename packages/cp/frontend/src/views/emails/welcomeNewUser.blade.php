...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{{$user->name}}</strong>,Your registration is completed</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
