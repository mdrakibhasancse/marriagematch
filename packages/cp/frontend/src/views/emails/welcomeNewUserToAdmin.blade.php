...
<div style="font-size:1px;line-height:25px"> </div><img alt="Image" border="0" class="left fixedwidth" src="https://marriagematchbd.com/uslive/original/logo1686719312.png" width="75" height="75" title="Image"/>
...
<div style="background-color:transparent;">
<div class="block-grid" style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #eee;">
<div style="border-collapse: collapse;display: table;width: 100%;background-color:#eee;">
...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>Admin</strong>,<br>A new user registration completed.</span></p>
</div>
</div>
...
<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">User Id: {{ $user->id }}.</span></p>

<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">User Name:  {{ $user->name}}.</span></p>

<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">User Email:  {{ $user->email}}.</span></p>

<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">User Mobile:  {{ $user->mobile }}.</span></p>

<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">User Gender:  {{ $user->gender}}.</span></p>

<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">User DOB: {{ Carbon\Carbon::parse($user->dob)->format('M d, Y')}}.</span></p>

<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">User Age:  {{$user->age()}}years,.</span></p>


<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">User Profession:  {{ $user->profession}}.</span></p>
<br>
...
{{-- <div style="color:#555555;font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;line-height:1.5;padding-top:5px;padding-right:10px;padding-bottom:0px;padding-left:10px;">
<div style="font-size: 12px; line-height: 1.5; color: #555555; font-family: Cabin, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px;">
<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">We wish this message reaches to you in the best of luck.</span></p>
...
<p style="line-height: 1.5; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
<p style="line-height: 1.5; word-break: break-word; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">Thank you so much for joining with us! <br/></span>
...
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 0px;" valign="top">
    <a href="{{ $ws->fb_url ?? '' }}" target="_blank">
    <span class=" " aria-hidden="true" height="32" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block; color: white;
    padding: 10px; border: 1px solid white;" width="32">F</span></a></td>
{{-- <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 0px;" valign="top">
    <a href="{{ $ws->twitter_url ?? '' }}" target="_blank"><span class="" aria-hidden="true"  height="32" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block; color: white;
        padding: 10px; border: 1px solid white;" width="32">t</span></a></td> --}}
 
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 0px;" valign="top">
    <a href="{{ $ws->linkedin_url ?? '' }}" target="_blank">
        <span class="" aria-hidden="true" height="32" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; display: block; color: white;
        padding: 10px; border: 1px solid white;" width="32">in</span>
    </a></td>
</tr>
</tbody>
</table>
...
<p style="line-height: 1.2; word-break: break-word; font-size: 16px; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;">Contact Us:</span><br/><br/></p>
<p style="line-height: 1.2; word-break: break-word; font-size: 16px; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;"><a href="tel:{!! $ws->contact_mobile ?? '' !!}" rel="noopener" style="text-decoration: underline; color: #ffffff;" target="_blank">{!! $ws->contact_mobile ?? '' !!}</a></span></p>

<p style="line-height: 1.2; word-break: break-word; font-size: 16px; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;"><a href="mailto:{!! $ws->contact_email ?? '' !!}" rel="noopener" style="text-decoration: underline; color: #ffffff;" target="_blank">{!! $ws->contact_email ?? '' !!}</a></span></p>
...
<p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">{{env('APP_NAME')}}<strong><br/><br/></strong></p>
<p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">{!! $ws->footer_address ?? '' !!}</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
