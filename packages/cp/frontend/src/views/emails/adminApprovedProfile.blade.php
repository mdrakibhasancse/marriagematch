...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{{ $user->name }}</strong>,<br>আপনার প্রোফাইলটি লাইভ করা হয়েছে.</span></p>
</div>
</div>
