                            ...
                            <div class="card-header">
                              ...
                              <div class="card-body">
                                 <div class="form-group ">
                                      ...
                                      <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title') ?: $story->meta_title ?? ''}}" id="meta_title" placeholder="Meta Title" autocomplete="off">
                                  </div>

                                  <div class="form-group ">
                                      <label for="meta_description" class="control-label">Meta Description </label>
                                      <textarea name="meta_description" class="form-control" rows="4" id="meta_description" placeholder="Meta Description for SEO">{{ old('meta_description') ?: $story->meta_description ?? ''  }}</textarea>
                                  </div>
                            </div>
                        </div>
                    </div>
