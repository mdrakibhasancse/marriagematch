                    ...
                    <div class="row py-2">
                        <div class="col-md-6 m-auto card p-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('language_code') is_invalid @enderror" id="language_code" placeholder="Language code" name="language_code" value="{{ old('language_code') }}">
                                @error('language_code')
