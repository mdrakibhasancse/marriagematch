@if($user->userEducationRecords->count())
                  ...
                  @foreach($user->userEducationRecords as $edu)
                    <tr>
                        ...
                        <td>
                            ...
                            --}}
                            <button type="button" class="btn btn-warning editEdu" data-toggle="modal" data-target="#modal-default" value="{{$edu->id}}" data-url="{{ route('admin.newProfileEducationEdit')}}">
                               <i class="fa fa-edit text-white"></i>
                            </button>

                            <a class="btn btn-danger" href="{{ route('admin.newProfileEducationDelete',$edu->id)}}"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
               </tbody>
...
<div class="modal fade" id="editEduModal">
    <div class="modal-dialog">
        ...
        <form method="post" action="{{ route('admin.newProfileEducationUpdate')}}">
