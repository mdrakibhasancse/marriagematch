...
@section('content') 
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Profile SubCategory Create</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
              <li class="breadcrumb-item active">Profile SubCategory Create</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header bg-info">
            <h4 class="card-title">Create Profile SubCategory</h4>
            <div class="card-tools">
                <a class="btn btn-primary btn-xs" href="{{ route('admin.profileSubCategoriesAll') }}"> Back</a>
            </div>
        </div>
        <form action="{{ route('admin.profileSubCategoryStore')}}" method="post"
          ...
          @csrf
            ...
            <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="title" placeholder="Enter SubCategory Title" value="{{ old('title')}}">
                     @error('title')
