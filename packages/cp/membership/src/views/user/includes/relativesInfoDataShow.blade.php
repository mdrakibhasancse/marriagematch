@if(Auth::user()->userRelativeRecords->count())
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered">
               ...
               <tbody>
                  @foreach(Auth::user()->userRelativeRecords as $relative)
                    <tr>
                        ...
                        <td>
                            ...
                            --}}
                            <button type="button" class="btn btn-warning editRelativeUserEnd" data-toggle="modal" data-target="#modal-default" value="{{$relative->id}}" data-url="{{ route('user.newProfileRelativeEdit')}}">
                               <i class="fa fa-edit text-white"></i>
                            </button>

                            <a class="btn btn-danger" href="{{ route('user.newProfileRelativeDelete',$relative->id)}}"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
               </tbody>
...
<div class="modal fade" id="editRelativeModalUserEnd">
    <div class="modal-dialog">
        ...
        <form method="post" action="{{ route('user.newProfileRelativeUpdate')}}">
