    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="fadeIn first">
                <img style="height: 100px; width:100px;" src="{{ asset('storage/ws/'.$ws->logo) }}" id="icon" alt="User Icon" />
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" style="margin-bottom: -15px;">
             ...
             <div class="">
                  <span>Don't have an account?<a href="{{ route('register')}}">Register Now</a><br></span>
                  <a href="{{ url('/')}}">Home</a>
             </div>
            <!-- Remind Passowrd -->
            <div id="formFooter">
